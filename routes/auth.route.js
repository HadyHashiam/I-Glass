...
router.get("/logout",  authGuard.isAuth,authController.getlogout)  
router.post("/logout",  authGuard.isAuth, bodyParser.urlencoded({ extended: true }),authController.postlogout)  
